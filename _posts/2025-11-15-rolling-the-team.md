---
layout: post
title: Tarea 7. Rolling the team
subtitle: "Roles de equipo, autoconocimiento y la influencia del contexto"
categories: [Roles de equipo]
tags: [Belbin, Personalidad, TrabajoEnEquipo, Autoconocimiento, Psicología]
---

## Introducción: Roles de Equipo y Autoconocimiento

En esta sesión nos centramos en los roles de equipo, tomando como base el modelo de Belbin, y también revisamos cómo estos roles no deben confundirse con rasgos personales más profundos como el temperamento, el carácter o la personalidad, algo que conectaba directamente con la teoría de Walter Mischel y el famoso experimento del marshmallow. Aunque no pude participar en las actividades grupales por estar en dispensa, el enfoque de la sesión me resultó igualmente útil para reflexionar sobre cómo funciono dentro de un equipo y en qué condiciones emerge cada parte de mí.

### Reflexión sobre los roles y su importancia

Una de las ideas que más me llamó la atención es que los roles no son "etiquetas permanentes", sino patrones de comportamiento que pueden activarse según el contexto y las necesidades del equipo. Esto encaja bien con la perspectiva de Mischel: la personalidad no es un bloque rígido, sino un conjunto de respuestas que cambian según la situación.
...
* Monitor Evaluator: me vi reflejada en esa tendencia a analizar varias opciones antes de decidir y en esa visión estratégica más fría. Reconozco que, a veces, eso puede llevarme a ser demasiado crítica o a tardar más en dar una respuesta.

* Completer Finisher: encaja completamente con mi forma de revisar detalles hasta que todo encaja y con mi preocupación por evitar errores. Es verdad que, en ocasiones, esto puede transformarse en ansiedad por el resultado.
...
La sesión también diferenciaba los roles del marco de Mischel:

* Personalidad: flexible y visible al principio.

* Carácter: aparece conforme un equipo va conociéndose.

* Temperamento: emerge en momentos de tensión.
...
En definitiva, esta sesión me ha servido para comprender mejor mis patrones al trabajar en equipo, identificar qué roles me salen naturales y cuáles puedo desarrollar y, sobre todo, aceptar que los roles son herramientas, no límites.

Creo que integrar esta visión puede mejorar mucho la forma en la que colaboro con los demás, adaptándome mejor a lo que el proyecto necesita en cada momento sin perder mi esencia.
